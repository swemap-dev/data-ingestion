...
-- Create the 3 Math Persons
INSERT INTO engineers (id, name, email) VALUES 
(1, 'Math Person A', 'a@calc.test'), 
(2, 'Math Person B', 'b@calc.test'), 
(3, 'Math Person C', 'c@calc.test');
...
INSERT INTO files (id, module_id, file_path) VALUES 
(100, 10, 'src/moduleA/main.py'), 
(101, 11, 'src/moduleB/utils.py');


-- 2. PHASE 1: GENESIS (Math Person A creates everything)
INSERT INTO commits (hash, repo_id, message) VALUES ('hash_init', 1, 'Initial Commit');

-- Person A adds 50 lines to both files.
...
-- Math Person B updates ModuleA (File 100)
